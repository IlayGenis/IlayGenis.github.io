        ...
        sections: [
          {
            title: "הצורך",
            paragraphs: [
              "סוכן קול צריך לנהל שיחה אמיתית בעברית ואז לעשות איתה משהו מועיל: לסנן ליד, לקבוע תור, לקלוט הזמנה, להעביר לאדם. פרומפט שנקרא טוב לא מוכיח שום דבר מזה. הסוכן נשפט בשיחה. מאחורי כל סוכן יש מנוע, הפלטפורמה שמריצה את השיחות. צוות אחר בונה אותו; מה שרץ עליו, האפיון, הפרומפט, הכלים והידע, זה העבודה שמתוארת כאן.",
